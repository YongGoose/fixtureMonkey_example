...
public final class FixtureMonkeyBuilder {
	...
	private final Map<String, Class<?>> registeredTypeListByRegisteredName = new HashMap<>();
	...
	public FixtureMonkeyBuilder registeredName(
		...
		this.registeredTypeListByRegisteredName.put(arbitraryName, type);
	...
	public FixtureMonkey build() {
		...
		return new FixtureMonkey(
			...
			registeredTypeListByRegisteredName
		);
	}
}
